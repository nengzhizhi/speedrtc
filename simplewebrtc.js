	...
	return function(e, t, n) {
		...
		16: [function(e, t) {
			...
			r.inherits(n, s), Object.defineProperty(n.prototype, "signalingState", {
				...
				return t = r ? t : e, t = t ||
				function() {}, "closed" === this.pc.signalingState ? t("Already closed") : (this.pc.createOffer(function(e) {
					var r = {
						type: "offer",
						sdp: e.sdp
					};
		...
		33: [function(e, t) {
			...
			t.exports = n, n.prototype.emitAll = function() {
				...
				var t = p(this.connected, e);~t && this.connected.splice(t, 1), this.connected.length || this.close()
					...
					if (i = function(e, t) {
						...
						var E = {
							...
							A = function(e, t, n, r, c, u, p) {
								...
								if ("object" == typeof d && d) if (f = s.call(d), f != h || o.call(d, "toJSON"))"function" == typeof d.toJSON && (f != g && f != m && f != v || o.call(d, "toJSON")) && (d = d.toJSON(e));
								else if (d > -1 / 0 && 1 / 0 > d) {
									if (k) {
						...
						p.stringify = function(e, t, n) {
							var r, o, i, a;
							if ("function" == typeof t || "object" == typeof t && t) if ((a = s.call(t)) == l) o = t;
							else if (a == v) {
								i = {};
					...
					if (!n("json-parse")) {
						var R, M, P = String.fromCharCode,
							...
							L = function() {
								...
								case 34:
									for (e = "@", R++; a > R;) if (o = i.charCodeAt(R), 32 > o) I();
							...
							U = function(e, t, n) {
								var r, o = e[t];
								if ("object" == typeof o && o) if (s.call(o) == v) for (r = o.length; r--;) B(o, r, n);
								else i(o, function(e) {
									B(o, e, n)
								});
								return n.call(e, t, o)
		...
		59: [function(e, t, n) {
			...
			n.deconstructPacket = function(e) {
				...
				function n(e, c, u) {
					...
					} else if (o(e)) for (var d = 0; d < e.length; d++) n(e[d], d, e);
					else if (e && "object" == typeof e && !i(e)) for (var f in e) n(e[f], f, e)
				}
				var a = 0,
					s = e;
				n(s), a || t(s)
		...
		90: [function(t, n, r) {
			...
			function(t) {
				...
				else if (h && !h.nodeType) if (g) g.exports = S;
				else {
					var k = {},
						C = k.hasOwnProperty;
